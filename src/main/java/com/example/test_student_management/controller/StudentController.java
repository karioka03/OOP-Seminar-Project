...
public class StudentController {
    ...
    @FXML private TextField searchField; // Added feature hook
    ...
    private FilteredList<Student> filteredStudents; // Added feature wrapper
    ...
    public void initialize() {
        ...
        // Initialize the filterable dataset wrapper targeting our core list
        filteredStudents = new FilteredList<>(students, p -> true);
        studentTable.setItems(filteredStudents);
        
        // Live search text listener logic
        searchField.textProperty().addListener((observable, oldValue, newValue) -> {
            filteredStudents.setPredicate(student -> {
                ...
                if (String.valueOf(student.getId()).contains(lowerCaseFilter)) {
                    return true;
                } else if (student.getStudentNumber() != null && student.getStudentNumber().toLowerCase().contains(lowerCaseFilter)) {
                    return true;
                ...
                return false; // Record does not match query
            });
        });
    ...
    private void loadPage(int pageIndex) throws SQLException {
        ...
        searchField.clear(); // Resets search when flipping pages to prevent index mismatches
    }
